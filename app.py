    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            connection = mysql.connector.connect(
                host='flaskapp.ctie4mg8o28y.us-east-1.rds.amazonaws.com',  # Replace with your RDS endpoint
                user='admin',               # Replace with your DB username
                password='Sandy3414',    # Replace with your DB password
                database='flaskapp'         # Replace with your DB name
            )
